...
OWNER = os.environ.get("OWNER", "TKC_Bots") # Owner username without @
...
BAN_SUPPORT = os.environ.get("BAN_SUPPORT", "https://t.me/+5QijJKZOOPIwODRl")
...
#--------------------------------------------
#--------------------------------------------
START_MSG = os.environ.get("START_MESSAGE", "<b>ʜᴇʟʟᴏ {mention}\n\n<blockquote> ᴇᴍɪʟʏ ʜᴇɴʀʏ ɪs ᴀɴ ᴀᴍᴇʀɪᴄᴀɴ ᴀᴜᴛʜᴏʀ ᴡʜᴏ ɪs ʙᴇsᴛ ᴋɴᴏᴡɴ ғᴏʀ ʜᴇʀ ɴᴇᴡ ʏᴏʀᴋ ᴛɪᴍᴇs ʙᴇsᴛsᴇʟʟɪɴɢ ʀᴏᴍᴀɴᴄᴇ ɴᴏᴠᴇʟs ʙᴇᴀᴄʜ ʀᴇᴀᴅ, ᴘᴇᴏᴘʟᴇ ᴡᴇ ᴍᴇᴇᴛ ᴏɴ ᴠᴀᴄᴀᴛɪᴏɴ, ʙᴏᴏᴋ ʟᴏᴠᴇʀs, ʜᴀᴘᴘʏ ᴘʟᴀᴄᴇ, ғᴜɴɴʏ sᴛᴏʀʏ, ᴀɴᴅ ɢʀᴇᴀᴛ ʙɪɢ ʙᴇᴀᴜᴛɪғᴜʟ ʟɪғᴇ.</blockquote></b>")
FORCE_MSG = os.environ.get("FORCE_SUB_MESSAGE", "ʜᴇʟʟᴏ {mention}\n\n<b><blockquote>ᴊᴏɪɴ ᴏᴜʀ ᴄʜᴀɴɴᴇʟ ᴀɴᴅ ᴛʜᴇɴ ᴄʟɪᴄᴋ ᴏɴ ʀᴇʟᴏᴀᴅ button ᴛᴏ ɢᴇᴛ ʏᴏᴜʀ ʀᴇǫᴜᴇꜱᴛᴇᴅ ꜰɪʟᴇ.</b></blockquote>")
